...
class WandBIntegration(Callback):
    ...
    def __init__(
        ...
        if not WANDB_AVAILABLE:
            raise ImportError("wandb not installed. Install: pip install wandb")
...
def setup_wandb(
    project: str, entity: Optional[str] = None, config: Optional[Dict] = None, **kwargs
) -> WandBIntegration:
    """
    ...
    """
    return WandBIntegration(project=project, entity=entity, config=config, **kwargs)
