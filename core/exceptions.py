...
class DimensionMismatchError(ModelError):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(message, expected=expected, received=received, 
...
class ModelNotFoundError(ModelError):
    ...
    def __init__(self, model_name: str, available: Optional[List[str]] = None, **kwargs):
        ...
        if available:
            # Find similar names
            similar = [name for name in available if model_name.lower() in name.lower() or name.lower() in model_name.lower()]
            if similar:
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(message, plugin_name=plugin_name, 
                        missing_methods=missing_methods, **kwargs)
