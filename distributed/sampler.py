...
class DistributedSampler(Sampler):
    ...
    def __init__(
        ...
        if num_replicas is None:
            from frameworm.distributed.utils import get_world_size
            num_replicas = get_world_size()
        
        if rank is None:
            from frameworm.distributed.utils import get_rank
            rank = get_rank()
...
def get_distributed_sampler(
    ...
    """
    from frameworm.distributed.utils import is_distributed
