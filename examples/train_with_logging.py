...
def main():
    ...
    scheduler = WarmupCosineScheduler(
        optimizer, warmup_epochs=2, total_epochs=cfg.training.epochs, min_lr=1e-6
    )
    ...
    trainer.add_callback(
        ModelCheckpoint("vae_epoch{epoch}.pt", monitor="val_loss", mode="min", save_best_only=False)
    )
