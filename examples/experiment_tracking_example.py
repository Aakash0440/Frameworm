...
def main():
    ...
    exp_id = run_experiment(
        name="vae-baseline", config_updates={}, tags=["vae", "mnist", "baseline"]
    )
    experiments.append(exp_id)

    # Experiment 2: Higher learning rate
    exp_id = run_experiment(
        name="vae-high-lr", config_updates={"training.lr": 0.002}, tags=["vae", "mnist", "high-lr"]
    )
    experiments.append(exp_id)

    # Experiment 3: Beta-VAE
    exp_id = run_experiment(
        name="vae-beta", config_updates={"model.beta": 4.0}, tags=["vae", "mnist", "beta-vae"]
    )
    experiments.append(exp_id)
    ...
    # Plot comparison
    print("\nGenerating plots...")
    plot_metric_comparison(manager, experiments, "loss", save_path="vae_loss_comparison.png")
    print("✓ Saved: vae_loss_comparison.png")

    plot_metric_comparison(
        manager, experiments, "val_loss", save_path="vae_val_loss_comparison.png"
    )
